...
local UITab3 = win:Tab("修改玩家",'16060333448')

local about = UITab3:section("修改玩家",true)
...
local about = UITab3:section("传送",true)
...
local about = UITab2:section("『卧推』",false)
